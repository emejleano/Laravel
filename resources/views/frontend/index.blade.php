...
@section('content')
    ...
    <div class="py-2">
        <div class="container  d-flex align-items-center justify-content-around p-4">
            ...
            <h3 style="font-size: 40px; font-weight:bolder; padding:5px;">Top Categories</h3>
            <div class="border border-dark " style="width:20rem; background:black;"></div>
        </div>
    </div>
    <div class="py-5">
                    ...
                    <a  href="{{url('/category')}}" class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            ...
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">ENGINEERING</h4>
                            </div>
                        </div>
                    </a>
                    <a href="{{url('/category')}}"   class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            ...
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">DESIGN & ENERGY</h4>
                            </div>
                        </div>
                    </a>
                    <a href="{{url('/category')}}" class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            ...
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">BLOWER</h4>
                            </div>
                        </div>
                    </a>
    ...
    <div class="container  d-flex align-items-center justify-content-around p-4">
        <div class="border border-dark " style="width:20rem; background:black;"></div>
        <h3 style="font-size: 40px; font-weight:bolder; padding:5px;">NEW ARRIVALS</h3>
        <div class="border border-dark " style="width:20rem; background:black;"></div>
    </div>
